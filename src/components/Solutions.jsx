...
const solutions = [
    {
        ...
        image: artritis,
        items: ["Tratar la inflamación y el daño a tus articulaciones así evitamos que se deformen y se desvíen tus manitos y tus pies.",
    ...
    },
    {
        ...
        image: artrosis,
        items: ["Disminuir el dolor y la rigidez, para que moverte no sea un sufrimiento diario.", 
    ...
    },
    {
        title: "Fibromialgia",
        image: fibromialgia,
        items: ["Sé que te duele todo el cuerpo desde la punta del cabello hasta la pies  , mi objetivo es bajar el dolor y esa electricidad ( hormigueo , adormecimiento ) en almenos un 70% .", 
    ...
    },
    {
        title: "Lupus",
        image: lupus,
        items: ["Controlar tus anticuerpos para evitar que ataque tus propios órganos.", 
    ...
    },
    {
        title: "Esclerodermia",
        image: esclerodermia,
        items: ["Controlar la actividad de la enfermedad, para frenar y ablandar el endurecimiento de tu piel y tus órganos internos.", 
    ...
    },
    {
        ...
        image: gota,
        items: [
                "Bajar la inflamación y el dolor de los ataques en los dedos , para que puedas caminar, dormir y trabajar sin crisis que te frenen la vida.",
    ...
    },
    {
        ...
        image: dolorcolumna,
        items: ["Disminuir el dolor en almenos un 50% y que puedas hacer tus actividades de la vida diaria.", 
    ...
    },
    {
        title: "Osteoporosis",
        image: osteoporosis,
        items: ["En este momento tus huesos están blandos aunque no lo sientas , hay mucho riesgo de fractura  ( la fractura de una vértebra o de la cadera = silla de ruedas).", 
                "Te ayudaré a fortalecer los huesos nuevamente , la osteoporosis es reversible si la diagnosticamos y la tratamientos a tiempo.", 
    ...
    },
    {
        ...
        items: ["La psoriasis no es solo piel y cabello . Lastimosamente afecta también las articulaciones de la mano ,  los tendones , la columna , los ojos , el intestino.", 
    ...
    },
    {
        ...
        image: dolorrodillas,
        items: ["Determinar cuáles son las causas por que hay muchas : Artrosis , Artritis , Depósitos de cristales , problemas de meniscos ) por accidentes.", 
    ...
    },
    {
        ...
        image: hormigueo,
        items: ["Este es un síntoma  que hay que estudiar por qué puede ser que el cuerpo está avisando la posibilidad de una enfermedad ", 
                "Mi objetivo será primero intentar sacarte esas molestias para que puedas seguir con tu vida cotidiana normalmente.", 
    ...
    },
    {
        ...
        items: ["Es una enfermedad difícil de diagnóstica y difícil de tratar pero no imposible ", 
                "Mi objetivo será que recuperes tu fuerza muscular al 100% ", 
